...
export default function OnlineCampaignPage(){
    ...
    <div className="py-5">
        ...
        <TikTokReelsPage url="/onlineCampaign3.mp4" view={'1.6K'} tiktokLink="https://www.tiktok.com/@twenty.bbq/video/7568505415106055432?is_from_webapp=1&sender_device=pc&web_id=7609397611892999696"/>
        ...
        <div className="col-span-3 w-full">
             <TikTokReelsPage url="/onlineCampaign6.mp4" view={'1.8K'} tiktokLink="https://www.tiktok.com/@twenty.bbq/video/7571854496666569991?is_from_webapp=1&sender_device=pc&web_id=7609397611892999696"/>
        </div>
    </div>
